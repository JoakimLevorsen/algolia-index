...
pub trait GramAtom:
    Default + Copy + Eq + Hash + Debug + Serialize + DeserializeOwned + Serializable + Deserializable
{
}
...
// struct GramOccurances<'a, G: GramAtom<'a>> {
//     gram: G,
//     occurances: usize,
// }

// pub struct GramData<'a, G: GramAtom<'a>, const N: usize> {
//     followed_by: [Vec<GramOccurances<G>>; N],
//     occurances: usize,
// }

// pub struct NGramIndex<'a, G: GramAtom<'a>, const N: usize, Data> {
//     pub grams: HashMap<G, GramData<G, N>>,
//     pub data: Vec<Data>,
// }

// impl<'a, G: GramAtom<'a>, const N: usize, Data> NGramIndex<G, N, Data> {
...
//     {
//         struct HashGramData<G: GramAtom<'a>, const N: usize> {
//             followed_by: [HashMap<G, usize>; N],
//             occurances: usize,
//         }

//         impl<G: GramAtom<'a>, const N: usize> HashGramData<G, N> {
